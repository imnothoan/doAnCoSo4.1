...
export default function ChatScreen() {
  ...
  // iOS Liquid Glass Message Bubble Component
  const GlassMessageBubble = ({ item, isOwnMessage }: { item: Message; isOwnMessage: boolean }) => {
    return (
      <BlurView
        intensity={80}
        ...
        style={[
          styles.glassBubble,
          isOwnMessage && styles.ownGlassBubble,
        ]}
      >
        <LinearGradient
          colors={
        ...
        >
          {!isOwnMessage && (
            <Text style={[styles.senderName, { color: colors.text }]}>
              {item.sender?.name || item.senderId}
            </Text>
          )}
          {item.image && (
            <Image
  ...
  const renderMessage = ({ item }: { item: Message }) => {
    ...
    return (
      ...
      >
        ...
        <GlassMessageBubble item={item} isOwnMessage={isOwnMessage} />
      </View>
    );
  };
        ...
        >
          ...
          {showQuickMessages && (
            <BlurView
              ...
              style={styles.quickMessagesPanel}
            >
              ...
              <View style={styles.quickMessagesList}>
                {quickMessages.map((qm, index) => (
                  ...
                  >
                    <Text style={[styles.quickMessageShortcut, { color: colors.primary }]}>
                      {qm.shortcut}
                    </Text>
          ...
          >
            ...
            <TouchableOpacity
              style={[
                ...
                {
                  backgroundColor:
                    inputText.trim().length > 0 ? colors.primary : 'rgba(128,128,128,0.3)',
                },
              ]}
